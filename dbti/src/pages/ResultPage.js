...
function ResultPage() {
  ...
  const currentUrl = "https://dbti-test.netlify.app/";
  ...
  return (
    <Wrapper backgroundColor={results[finalType].color}>
      <Container>
        ...
        <Title>❓ 집 주인이 궁금하다면?</Title>
        <FlexLayout>
          <HomeSquare>
            <BtnToPage
              exact
              to="https://puffy-citrine-4bd.notion.site/ea54141f70724483b375e0f98aac3084"
            >
              <ButtonComponent text={"집주인 구경하기"} />
            </BtnToPage>
          </HomeSquare>
        </FlexLayout>
      </Container>
